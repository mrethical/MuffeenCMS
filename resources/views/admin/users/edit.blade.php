    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="page-header">
                <h1>Edit User</h1>
                <a href="{{ url('/admin/users') }}" class="btn btn-default pull-right">Back to List</a>
            </div>
        </div>
        @if($edited)
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-md-4">
                        <select class="form-control" name="type">
                            ...
                            <option value="{{ $usertype }}" {{ (((old('type')) ? old('type') : $user->type) === $usertype) ? 'selected' : '' }}>{{ $usertype }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
