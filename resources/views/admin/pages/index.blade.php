    ...
    <section id="content-body" class="content">
        ...
        @if ($added = request()->session()->get('added', null))
            <div class="alert alert-success alert-dismissable">
                ...
                <p>New page added. <a href="{{ url('admin/posts/'. $added . '/edit') }}">Edit Page</a></p>
            </div>
        @endif
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr class="empty-table-row">
                                <td colspan="3">
                                    No records to show. <a href="{{ url('/admin/pages/create') }}">Add New</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="box-footer">
                        <label>Actions:</label>
                        <br>
                        <a href="{{ url('/admin/pages/create') }}" class="btn btn-flat btn-primary">Add New</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>You are about to delete a pages. 'Cancel' to stop, 'OK' to delete.</p>
                </div>
...
@section('scripts')
    ...
    <script src="{{ mix('js/admin/pages/index.js') }}"></script>
