        ...
        <table class="table table-bordered table-responsive">
            ...
            @foreach($categories as $category)
                <tr>
                    <td>{{ $category->name }}</td>
                    <td>
                        <button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modal-category" data-action="Edit" data-id="{{ $category->id  }}" data-name="{{ $category->name }}">Edit</button>
