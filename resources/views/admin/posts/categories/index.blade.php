    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div id="table-container">
                @include('admin.posts.categories.tables.posts-categories-table', ['categories'])
            </div>
        </div>
        <div class="col-lg-12">
                ...
                <div class="modal-body">
                    <form>
                        <div id="modal-category-form-name" class="form-group">
                            <input type="hidden" id="category-post-token" value="{{ csrf_token() }}" />
                            <label for="category-name" class="control-label">Name:</label>
                            <input type="hidden" class="form-control" id="category-id" />
                            <input type="text" class="form-control" id="category-name" />
                        </div>
                        <div id="modal-category-form-parent" class="form-group">
                            <label for="category-parent" class="control-label">Parent:</label>
                            <select class="form-control" id="category-parent"></select>
                        </div>
                    </form>
                </div>
...
@section('scripts')
    ...
    <script src="{{ elixir('js/admin/posts-categories.js') }}"></script>
